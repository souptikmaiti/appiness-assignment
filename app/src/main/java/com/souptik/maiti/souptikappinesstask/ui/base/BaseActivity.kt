...
import com.souptik.maiti.souptikappinesstask.di.components.DaggerActivityComponent
...
abstract class BaseActivity<VM : BaseViewModel> : AppCompatActivity() {
    ...
    private fun buildActivityComponent() =
        DaggerActivityComponent
            .builder()
            .applicationComponent((application as AppinessApplication).applicationComponent)
